...
// Se esse link não abrir no Brasil, geralmente é: 'https://shopee.com.br/asprofort' (ou o link exato da loja).
...
const Hero = () => {
  ...
  const handleWhatsApp = () => {
    window.open('https://wa.me/5555999713752?text=Ol%C3%A1%2C%20vi%20no%20site%20e%20tenho%20interesse%20em%20um%20produto%2C%20pode%20me%20ajudar%3F', '_blank', 'noopener,noreferrer');
  };
    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pb-24">
        ...
        >
          ...
          >
            Cornetas e acessórios de competição para Carburadores e Tbi.
          </motion.p>
          ...
          >
            <Button
              ...
              className="btn-racing px-8 py-4 text-lg font-bold flex items-center gap-3 min-w-[200px]"
            >
              <ShoppingBag size={24} />
              Loja Shopee
            </Button>
            ...
            <Button
              ...
              variant="outline"
              className="border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white px-8 py-4 text-lg font-bold flex items-center gap-3 min-w-[200px] transition-all duration-300"
            >
